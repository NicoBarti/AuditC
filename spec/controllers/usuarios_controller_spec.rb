...
RSpec.describe UsuariosController, type: :controller do
  ...
  let(:valid_attributes) {
    FactoryGirl.build(:usuario).attributes
  }

  let(:invalid_attributes) {
    FactoryGirl.build(:usuario, nombre: nil).attributes
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        valid_attributes.merge(nombre: "Some Other Name")}
      ...
      it "updates the requested usuario" do
        ...
        usuario.reload
        expect(assigns(:usuario).nombre).to eq("Some Other Name")
      end
